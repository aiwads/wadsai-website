    ...
    <section id="services" style={{ background: '#E4E4DE', marginTop: '-40px', paddingTop: '0' }}>
      <style>{`
        @media (max-width: 768px) {
          ...
          .services-col { padding: 40px 24px 32px !important; border-right: none !important; width: 100% !important; max-width: 100% !important; box-sizing: border-box !important; height: auto !important; overflow: visible !important; }
          .services-col:not(:last-child) { border-bottom: 1px solid rgba(26,26,22,0.10); }
          .services-split-bg { background: #E0DDD6 !important; width: 100% !important; max-width: 100vw !important; height: auto !important; overflow: visible !important; }
        }
